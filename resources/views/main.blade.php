<x-layout>
    ...
    <div class="flex items-center justify-center ">
        ...
        <div class="relative z-10 flex items-center justify-center gap-3 text-4xl text-white sm:text-5xl md:text-6xl font-extrabold tracking-tight">
    ...
    <x-slot>
        <div class="p-10 font-sans  flex flex-col items-center">
    ...
    <div class="group border border-[#3b3834] rounded-2xl overflow-hidden shadow-lg 
                hover:-translate-y-2 hover:border-emerald-500/50 hover:shadow-emerald-900/20 transition-all duration-300 flex flex-col text-black dark:text-white bg-white dark:bg-zinc-950">
        
        <div class="p-6 flex-grow text-center">
            <div class="overflow-hidden rounded-xl mb-6 shadow-inner">
            ...
            <h2 class="text-xl font-bold mb-4 uppercase tracking-widest group-hover:text-emerald-400 transition-colors">
                Véleményírás
            </h2>
        ...
        <div class="p-4 border-t border-[#3b3834]">
            <a href="/restaurants" class="block w-full text-center py-3 rounded-xl bg-transparent border border-emerald-500/30 text-emerald-400 font-semibold
                                          hover:bg-emerald-500 hover: transition-all duration-300">
                Kezdés most
            </a>
        </div>
    </div>
    ...
    <div class="group border border-[#3b3834] rounded-2xl overflow-hidden shadow-lg 
                hover:-translate-y-2 hover:border-teal-500/50 hover:shadow-teal-900/20 transition-all duration-300 flex flex-col text-black dark:text-white bg-white dark:bg-zinc-950">
        ...
        <div class="p-6 flex-grow text-center">
            ...
            <h2 class="text-xl font-bold mb-4 uppercase tracking-widest  group-hover:text-teal-400 transition-colors">
                Étteremkeresés
            </h2>
            
            <p class="text-sm -400 leading-relaxed mb-4">
        ...
        <div class="p-4 border-t border-[#3b3834]">
            <a href="/restaurants" class="block w-full text-center py-3 rounded-xl bg-transparent border border-teal-500/30 text-teal-400 font-semibold
                                          hover:bg-teal-500 hover: transition-all duration-300">
                Keresés indítása
            </a>
        </div>
    </div>
         ...
         <div class="group border border-[#3b3834] rounded-2xl overflow-hidden shadow-lg 
                     hover:-translate-y-2 hover:border-blue-500/50 hover:shadow-blue-900/20 transition-all duration-300 flex flex-col text-black dark:text-white bg-white dark:bg-zinc-950">
             ...
             <div class="p-6 flex-grow text-center">
                 ...
                 <h2 class="text-xl font-bold mb-4 uppercase tracking-widest group-hover:text-blue-400 transition-colors">
                     Allergénlista
                 </h2>
             ...
             <div class="p-4 border-t border-[#3b3834]">
                 <a href="/myallergenlist" class="block w-full text-center py-3 rounded-xl bg-transparent border border-blue-500/30 text-blue-400 font-semibold
                                               hover:bg-blue-500 hover: transition-all duration-300">
            ...
            @else
            <h1 class="text-3xl text-center mb-16 uppercase text-black dark:text-white">
              Üdvözlünk a Mentesch weboldalán!
            </h1>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full px-4">
    
    <div class="group border border-[#3b3834] rounded-2xl overflow-hidden shadow-lg 
                hover:-translate-y-2 hover:border-emerald-500/40 hover:shadow-emerald-900/10 transition-all duration-300 flex flex-col text-black dark:text-white bg-white dark:bg-zinc-950">
        ...
        <div class="p-6 flex flex-col text-center flex-grow">
            <h2 class="text-xl font-bold mb-4 uppercase tracking-[0.2em] group-hover:text-emerald-400 transition-colors">
                Élet
            </h2>
            <p class="text-sm leading-relaxed mb-4">
    ...
    <div class="group border border-[#3b3834] rounded-2xl overflow-hidden shadow-lg 
                hover:-translate-y-2 hover:border-teal-500/40 hover:shadow-teal-900/10 transition-all duration-300 flex flex-col text-black dark:text-white bg-white dark:bg-zinc-950">
        ...
        <div class="p-6 flex flex-col text-center flex-grow">
            <h2 class="text-xl font-bold mb-4 uppercase tracking-[0.2em]  group-hover:text-teal-400 transition-colors">
                Élmény
            </h2>
            <p class="text-sm leading-relaxed mb-4">
        ...
        <div class="h-1.5 w-full bg-teal-600/20 group-hover:bg-teal-500 transition-colors"></div>
                ...
                <div class="group border border-[#3b3834] rounded-2xl overflow-hidden shadow-lg 
                            hover:-translate-y-2 hover:border-blue-500/40 hover:shadow-blue-900/10 transition-all duration-300 flex flex-col text-black dark:text-white bg-white dark:bg-zinc-950">
                    ...
                    <div class="p-6 flex flex-col text-center flex-grow">
                        <h2 class="text-xl font-bold mb-4 uppercase tracking-[0.2em] group-hover:text-blue-400 transition-colors">
                            Segítség
                        </h2>
                        <p class="text-sm font-semibold mb-2 italic">
                            Mire vársz még? Próbáld ki a funkciókat még ma!
                        </p>
                        <div class="mt-auto pt-4">
                            <p class="text-[10px] border-t border-[#3b3834] pt-4">
